            ...
            <div className="space-y-8">
              <div className="flex items-center space-x-6">
                <div className="relative group">
                  <div 
                    className="w-32 h-32 rounded-full flex items-center justify-center overflow-hidden cursor-pointer transition-transform hover:scale-105 relative"
                    style={{
                      backgroundColor: editedUser.avatarColor,
                      backgroundImage: editedUser.avatarImage ? `url(${editedUser.avatarImage})` : 'none',
                      backgroundSize: 'cover',
                      backgroundPosition: 'center'
                    }}
                  >
                    {!editedUser.avatarImage && (
                  ...
                  {isEditing && editedUser.avatarImage && (
                    <button
                      onClick={handleRemoveImage}
                      className="mt-2 text-red-500 text-sm hover:text-red-600 flex items-center"
                    >
                  ...
                  {isEditing && (
                    <div className="absolute -bottom-2 right-0 flex space-x-2">
                      <button 
                        ...
                        className="bg-blue-500 text-white p-2 rounded-full shadow-lg hover:bg-blue-600 transition-all transform hover:scale-110"
                        title="Изменить цвет"
                      >
